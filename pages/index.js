...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif", background: "#0d0d0d", color: "#fff", minHeight: "100vh" }}>
      ...
      {loading ? (
        <div style={{
          ...
          <div style={{ width: "80%", height: "6px", background: "rgba(255,255,255,0.1)", borderRadius: "3px", overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${(indexRef.current / text.length) * 100}%`, background: "linear-gradient(90deg, #ec4899, #a855f7, #06b6d4)", borderRadius: "3px", transition: "width 0.3s linear" }} />
          </div>
        </div>
      ) : (
        <div style={{
          display: "flex", justifyContent: "center", alignItems: "center",
          flexDirection: "column", minHeight: "100vh", padding: "20px", textAlign: "center", zIndex: 1
        }}>
          <div style={{
            width: "100%", maxWidth: "420px", background: "linear-gradient(180deg, rgba(25,25,25,0.95), rgba(15,15,15,0.95))",
            borderRadius: "20px", padding: "25px", textAlign: "center",
            boxShadow: "0 0 40px rgba(236,72,153,0.2)", position: "relative",
            backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.05)"
          }}>
            <div style={{ position: "relative" }}>
              <img src="https://raw.githubusercontent.com/Yudzxml/UploaderV2/main/tmp/e53304b6.jpg" alt="avatar" style={{ width: "110px", height: "110px", borderRadius: "50%", border: "4px solid #ec4899", boxShadow: "0 0 20px rgba(236,72,153,0.5)", objectFit: "cover", transition: "transform .4s ease" }} />
              <span style={{ position: "absolute", top: "90px", right: "calc(50% - 55px)", width: "18px", height: "18px", background: "#22c55e", border: "2px solid #111", borderRadius: "50%" }} />
            </div>
            <h1 style={{
              marginTop: "15px", fontSize: "clamp(22px,5vw,28px)", fontWeight: 700,
              background: "linear-gradient(90deg,#ec4899,#a855f7,#06b6d4)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"
            }}>Yudzxml</h1>
            ...
            <h2 style={{ marginTop: "25px", marginBottom: "12px", fontSize: "clamp(14px,4vw,16px)", fontWeight: 600, background: "linear-gradient(90deg,#22d3ee,#ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Connect With Me</h2>
